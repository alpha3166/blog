...
以前「[自炊PDFを第3世代iPadに最適化する その3]({{ site.baseurl }}{% post_url 2012-07-15-自炊PDFを第3世代iPadに最適化する-その3 %})」で紹介した方法では、pdfimagesで一旦PDFから全JPEGを書き出し、ImageMagickで縮小したあと、pdftkで再度PDFに組み立て直していました。
