# ANAのフライトをユナイテッドMileagePlusに事後加算する

2016-10-16作成

スターアライアンスに乗ったときはマイルをユナイテッド航空のマイレージプラスに貯めてるんですが、この夏ANAの国内線に乗ったとき、うっかりそれを言い忘れてしまい、あとから加算してもらいました([http://blogs.yahoo.co.jp/alpha3166/6198338.html 5年前にアイスランド旅行したとき]以来ずっと飛行機乗ってなくて、そういうの忘れてたわ……)。

ざっくり結論だけ言うと、
1) ANAのサイトで英文の領収書を取得
2) 搭乗日から15日後以降に、ユナイテッドのサイトのメールフォームからそれを送る
