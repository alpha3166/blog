# 自炊PDFを第3世代iPadに最適化する その4

2016-10-30作成

(→[その1](20120325.md)、[その2](20120401.md)、[その3](20120715.md)、その4)
...
以前「[自炊PDFを第3世代iPadに最適化する その3](20120715.md)」で紹介した方法では、pdfimagesで一旦PDFから全JPEGを書き出し、ImageMagickで縮小したあと、pdftkで再度PDFに組み立て直していました。
