...
このインストールエラーが、パッケージが作られていない原因かもしれません。ただ、[http://portsmon.freebsd.org/portoverview.py?category=textproc&portname=eruby PortsMon]などを見ても、現時点では特に問題は報告されておらず、詳しいことは追求しないことにします。
...
[http://blogs.yahoo.co.jp/alpha3166/11996677.html その2]に続く。
...
※更新履歴
・2014年4月19日 最後の例から「line.encode(Encoding::UTF_8)」の行を削除。
